...
parser.add_argument('--testroot', default="FEI", type=str, help='path to dataset')
parser.add_argument('--trainsize', type=int, help='number of training data', default=1000)
