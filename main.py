...
parser.add_argument('--dataroot', default="CASPEAL", type=str, help='path to dataset')
parser.add_argument('--testfiles', default="test.list", type=str, help='the list of training files')
parser.add_argument('--testroot', default="CASPEAL", type=str, help='path to dataset')
parser.add_argument('--trainsize', type=int, help='number of training data', default=800)
parser.add_argument('--testsize', type=int, help='number of testing data', default=200)
